	...
	\section{Bibliographie}
		...
		\begin{frame}[allowframebreaks]
			...
			\begin{thebibliography}{5}
				...
				\bibitem[8]{functional_degrees_source} Tonal Degrees [Online]. [Accessed 30 Jan 2020]. Available from : http://www.piano-play-it.com/musical-scales.html
			\end{thebibliography}
		\end{frame}
\end{document}
=======
	...
	\end{frame}
\end{document}
>>>>>>> 52dd6f478a0a94f821aaf70f918820b557b245b2
