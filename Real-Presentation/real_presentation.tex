...
\begin{document}
    ...
    \begin{frame}
		\frametitle{Algorithms for Computing Geometric Measures of Melodic Similarity}
		\begin{minipage}{0.45\textwidth}
			\begin{center}
	...
	\begin{frame}[allowframebreaks]
		...
		\begin{thebibliography}{5}
            ...
            \bibitem[11]{wikipedia_nee_wu} Wikipedia, Needlemann-Wunsch-Algorithmus, https://de.wikipedia.org/wiki/Needleman-Wunsch-Algorithmus, aberufen am 02.02.20 
            \end{thebibliography}
	\end{frame}
\end{document}
