...
%              \note[item]<1>{The constantsμpandμtarethe mean scores returned by thediffpanddifftfunctionsover  a  random  sample  of  100,000  pairs  of  spline  spans
%             drawn  from  the  Essen  Collection  (μp=  2.1838andμt= 0.4772)}
%              \note[item]<1>{k t = 0.5 is a constant that weights
%             the time dissimilarity with respect to the pitch dissimilar-
%                 ity; and λ = μ p /μ t is a constant that normalizes time
